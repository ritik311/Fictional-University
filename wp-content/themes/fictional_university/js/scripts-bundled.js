  ...
  _createClass(Search, [{
    ...
    value: function getResults() {
      ...
      _jquery.default.getJSON(universityData.root_url + '/wp-json/university/v1/search?term=' + this.searchField.val(), function (results) {
        ...
        }).join(''), "\n            ").concat(results.programs.length ? '</ul>' : '', "\n\n            <h2 class=\"search-overlay__section-title\">Professors</h2>\n             ").concat(results.professors.length ? '<ul class="professor-cards">' : "<p>No professors match that search.\n             </p>", "\n              ").concat(results.professors.map(function (item) {
        ...
        }).join(''), "\n            ").concat(results.professors.length ? '</ul>' : '', "\n          </div>\n\n          <div class=\"one-third\">\n            <h2 class=\"search-overlay__section-title\">Campuses</h2>\n            ").concat(results.campuses.length ? '<ul class="link-list min-list">' : "<p>No campuses match that search.<a href=\"".concat(universityData.root_url, "/programs\">View all campuses</a></p>"), "\n              ").concat(results.campuses.map(function (item) {
          return "<li><a href=\"".concat(item.permalink, "\">").concat(item.title, "</a> </li>");
  ...
  _createClass(MyNotes, [{
    ...
    value: function createNote(e) {
      ...
      _jquery.default.ajax({
        ...
        // note can also be posts or pages
        type: 'POST',
        data: ourNewPost,
        success: function success(response) {
